...
Then one can add the `ffmsl-eol-ssid` package to the old version and leave a much noticed note in the ssid to switch to a supported device.
...
- https://github.com/freifunk-gluon/community-packages/tree/master/ffac-eol-ssid
